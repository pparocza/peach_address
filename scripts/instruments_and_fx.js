...
PercussionPresets.prototype = {
	...
	perc77: function(){
		...
		this.mG = new MyGain(this.mI);
		this.mE = new MyBuffer(1, 1, audioCtx.sampleRate);
		this.mE.makeInverseSawtooth(this.sTE);
...
PitchedPresets.prototype = {
	...
	pitch70: function(){
		...
		this.mO.connect(this.o.frequencyInlet);
